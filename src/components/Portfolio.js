          ...
          <Section title="" theme={theme}>
            <div className="max-w-4xl mx-auto space-y-12">
              ...
              >
                ...
                >
                  Building modern web experiences with HTML5, CSS3, JavaScript,
                  and React.js
                </motion.p>
                <motion.p
                ...
                >
                  Currently advancing in Data Structures & Algorithms, exploring
                  mobile development, and expanding into blockchain engineering
                  for 2025
                </motion.p>
              </motion.div>
              ...
              >
                ...
                <div className="flex flex-wrap gap-4">
                  ...
                  <motion.a
                    href="https://salmon-kania-79.tiiny.site"
                    className={`
                      px-6 py-3 rounded-full text-lg font-semibold
            ...
            <div className="space-y-16">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  >
                    Frontend Developer | Currently advancing in Data Structures
                    & Algorithms
                  </p>
                </div>
              </div>
                    ...
                    <div className="space-y-6">
                      ...
                      >
                        <li className="flex items-start gap-3">
                          ...
                          <span>
                            Develop and maintain responsive web interfaces using
                            React.js, focusing on user experience and
                            accessibility
                          </span>
                        </li>
                        <li className="flex items-start gap-3">
                          <span className="mt-1.5 w-2 h-2 rounded-full bg-blue-500 flex-shrink-0"></span>
                          <span>
                            Collaborate with design team to implement
                            pixel-perfect UI using HTML5, CSS3, and TailwindCSS
                          </span>
                        </li>
                        <li className="flex items-start gap-3">
                          <span className="mt-1.5 w-2 h-2 rounded-full bg-blue-500 flex-shrink-0"></span>
                          <span>
                            Write clean, maintainable JavaScript code following
                    ...
                    <div className="space-y-6">
                      ...
                      >
                        <li className="flex items-start gap-3">
                          <span className="mt-1.5 w-2 h-2 rounded-full bg-blue-500 flex-shrink-0"></span>
                          <span>
                            Developed JaneezyBeats platform with React and
                            modern CSS
                          </span>
                        </li>
                        <li className="flex items-start gap-3">
                          <span className="mt-1.5 w-2 h-2 rounded-full bg-blue-500 flex-shrink-0"></span>
                          <span>
                            Created responsive restaurant and gym websites
                          </span>
                        </li>
                      </ul>
                      <div className="flex flex-wrap gap-2">
                        {["React", "JavaScript", "HTML5", "CSS3"].map(
                          (tech) => (
                            <span
                              key={tech}
                              className={`px-3 py-1 text-sm font-medium rounded-full
                    ...
                    <div className="space-y-4">
                      ...
                      >
                        <li className="flex items-start gap-3">
                          <span className="mt-1.5 w-2 h-2 rounded-full bg-blue-500 flex-shrink-0"></span>
                          <span>
                            Led team of 12 representatives, improving retention
                            by 25%
                          </span>
                        </li>
                        <li className="flex items-start gap-3">
                          <span className="mt-1.5 w-2 h-2 rounded-full bg-blue-500 flex-shrink-0"></span>
                          <span>
                            Managed high-priority client portfolio worth €2M
                            annually
                          </span>
                        </li>
                      </ul>
                    ...
                    <div className="space-y-4">
                      ...
                      >
                        <li className="flex items-start gap-3">
                          <span className="mt-1.5 w-2 h-2 rounded-full bg-blue-500 flex-shrink-0"></span>
                          <span>
                            Achieved 13% year-over-year growth through strategic
                            team management
                          </span>
                        </li>
                        <li className="flex items-start gap-3">
                          <span className="mt-1.5 w-2 h-2 rounded-full bg-blue-500 flex-shrink-0"></span>
                          <span>
                            Developed and mentored 15+ team members to career
                            advancement
                          </span>
                        </li>
                      </ul>
                ...
                <Card
                  ...
                  content={
                    <div className="space-y-4">
                      ...
                      >
                        Combined expertise in cryptocurrency markets and
                      ...
                      >
                        <li className="flex items-start gap-3">
                          <span className="mt-1.5 w-2 h-2 rounded-full bg-blue-500 flex-shrink-0"></span>
                          <span>
                            Mastered cryptocurrency trading and blockchain
                        ...
                        <li className="flex items-start gap-3">
                          <span className="mt-1.5 w-2 h-2 rounded-full bg-blue-500 flex-shrink-0"></span>
                          <span>
                            Developed analytical and problem-solving skills in
                            fast-paced markets
                          </span>
                        </li>
                      </ul>
              ...
              <Card
                title={
                  <div className="space-y-2">
                    ...
                    >
                      Mobile development with React Native while expanding my
                      knowledge in algorithms and data structures to build
              ...
              >
                <div className="flex flex-col md:flex-row gap-8">
                  <div className="flex-1 space-y-6">
                    ...
                    >
                      Original beats produced and crafted by me, featuring
                      unique sounds across multiple genres. Professional beat
                      store integrated with BeatStars Pro Page, offering
                      seamless music distribution and licensing. Custom-branded
                      storefront for premium beat sales and instant delivery.
                    </p>
                    ...
                    <div className="mb-6">
                      ...
                      >
                        <li className="flex items-start gap-2">
                          ...
                          <span>
                            Exclusive beats produced by me, available for
                            instant purchase
                          </span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="mt-1.5 w-2 h-2 bg-blue-500 rounded-full flex-shrink-0"></span>
                          <span>
                            Professional licensing options for all budgets
                          </span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="mt-1.5 w-2 h-2 bg-blue-500 rounded-full flex-shrink-0"></span>
                          <span>
                            Secure platform with instant beat delivery
                          </span>
                        </li>
                      </ul>
                    </div>
                  ...
                  <Card
                    ...
                    content={
                      <div className="space-y-4">
                        ...
                        >
                          Frontend restaurant management system with real-time
                        ...
                        <div className="space-y-3">
                          ...
                          >
                            <li>
                              Implemented using Html and CSS3 for real-time
                              order updates
                            </li>
                            <li>
                        ...
                        <div className="flex flex-wrap gap-2 mt-4">
                          {["React", "WebSocket", "Node.js", "Stripe"].map(
                            (tech) => (
                              <span
                                key={tech}
                                className={`px-3 py-1 text-sm font-medium rounded-full
                  ...
                  <Card
                    ...
                    content={
                      <div className="space-y-4">
                        ...
                        >
                          Modern fitness platform with membership management and
                        ...
                        <div className="space-y-3">
                          ...
                          >
                            <li>
                              Custom animation system for workout demonstrations
                            </li>
            ...
            <div className="space-y-16">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  >
                    Currently progressing in System Design, Advanced Algorithms,
                  ...
                  content={
                    <div className="space-y-4 mt-4">
                      ...
                      >
                        ...
                        <li>
                          React.js & React Native Masterclass - January 2023
                        </li>
                        <li>
                          Web Development & JavaScript Advanced Skills - 2022
                        </li>
                ...
                <Card
                  ...
                  content={
                    <div className="space-y-4 mt-4">
                      ...
                      >
                        Comprehensive business and economics training from IBM,
                        covering market analysis, business strategy, and
                        economic principles.
                      </p>
                      <div className="flex flex-wrap gap-2">
                        {[
                ...
                <Card
                  ...
                  content={
                    <div className="space-y-4 mt-4">
                      ...
                      >
                        Specialized training in cryptocurrency markets and
                        blockchain technology, leading to roles in financial
                        services.
                      </p>
                      <div className="flex flex-wrap gap-2">
                        {[
                ...
                <Card
                  ...
                  content={
                    <div className="space-y-4 mt-4">
                      ...
                      >
                        Completed medical education before successfully
                        transitioning into technology and finance sectors,
                        demonstrating strong adaptability and commitment to
                        continuous learning.
                      </p>
                      <div className="flex flex-wrap gap-2">
                        {[
            ...
            <div className="space-y-12">
              ...
              >
                <div className="space-y-4">
                  ...
                  >
                    If you find my work valuable, consider supporting my open
